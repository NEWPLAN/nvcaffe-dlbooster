...
class FPGAReader : public InternalThread {
 private:
  class CursorManager {
   ...
   public:
    CursorManager(db::DB* db, FPGAReader* reader, size_t solver_count,
...
template <typename DatumType>
unique_ptr<typename FPGAReader<DatumType>::DataCache>
    FPGAReader<DatumType>::DataCache::data_cache_inst_;
